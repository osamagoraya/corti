...
trait UserAttribute
{
     ...
     * @return string
     */
    public function getConfigureButtonAttribute()
    {
        return '<a href="'.route('frontend.staff.configure.doctor', $this).'" class="btn btn-primary"><i class="fa fa-adjust" data-toggle="tooltip" data-placement="top" title="'.__('buttons.general.crud.configure').'"></i></a>';
    }
