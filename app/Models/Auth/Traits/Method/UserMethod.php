...
trait UserMethod
{
    ...
    {
        return $this->hasRole(config('access.users.doctor_role'));
    }
    ...
    {
        return $this->hasRole(config('access.users.staff_role'));
    }
    ...
    {
        return $this->hasRole(config('access.users.patient_role'));
    }
